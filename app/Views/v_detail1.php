              ...
              <div class="product-item-holder size-big single-product-gallery small-gallery">
                <div id="owl-single-product">
                  <div class="single-product-gallery-item" id="slide1">
                    <a data-lightbox="image-1" data-title="Gallery" href="<?= base_url('assets/images/products/p1.jpg') ?>">
                      <img class="img-responsive" alt="" src="<?= base_url('assets/images/blank.gif') ?>" data-echo="<?= base_url('assets/images/products/p1.jpg') ?>" />
                    </a>
